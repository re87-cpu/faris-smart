...
function normalizeTaskForUI(t) {
  ...
  return {
    ...
    // IMPORTANT: keep yyyy-mm-dd for input
...
export default function AdminTasks() {
  ...
  async function onToggle(t) {
    ...
    try {
      setBusyId(t.id);
      await toggleMyTask(t.id, !t.done); // /my/tasks/:id
      await load();
    } catch (e) {
  ...
  async function onQuickDate(t, e) {
    ...
    try {
      ...
      await updateMyTask(t.id, { due_at: v ? v : null }); // yyyy-mm-dd or null
      await load();
    } catch (ex) {
